...
**get_group_dataset_names(group_path)**
...
### get_name_from_hdf5_path

**get_name_from_hdf5_path(hdf5_path)**
...
```{python}
dataset_name = hdf5_object.get_name_from_hdf5_path(hdf5_path="/Group 1/Dataset A")
```
```{python, echo=FALSE}
print(dataset_name)
```
